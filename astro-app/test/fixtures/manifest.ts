...
export const fixtures: FixtureEntry[] = [
  ...
  {
    scraper: 'mx_inmuebles24',
    fixture: 'mx_inmuebles24',
    sourceUrl: 'https://www.inmuebles24.com/propiedades/clasificado/veclapin-remato-departamento-en-del-valle-norte-benito-juarez-145692212.html',
    expected: {
      agent_company: "Rome Remates",
      city: "Benito Juárez",
      constructed_area: 110,
      count_bedrooms: 2,
      count_parking: 2,
      country: "Mexico",
      currency: "MXN",
      ...
      plot_area: 110,
      price_float: 1500000,
      price_string: "MN 1,500,000",
      property_type: "Apartment",
      reference: "145692212",
      region: "Del Valle Norte",
      title: "Remato Departamento en del Valle Norte, Benito Juarez, Ciudad de México - Inmuebles24",
    },
  },
  {
    scraper: 'ae_propertyfinder',
    fixture: 'ae_propertyfinder',
    sourceUrl: 'https://www.propertyfinder.ae/en/plp/buy/villa-for-sale-dubai-dubai-hills-estate-sidra-villas-sidra-villas-i-2PMJT8Ul732.html',
    expected: {
      agent_company: "haus & haus",
      agent_name: "Jamie Hemingway",
      city: "Dubai",
      constructed_area: 3323,
      count_bathrooms: 4,
      count_bedrooms: 3,
      country: "United Arab Emirates",
      currency: "AED",
      ...
      for_rent_long_term: false,
      for_sale: true,
      latitude: 25.093286514282227,
      locale_code: "en-AE",
      longitude: 55.24822235107422,
      price_float: 12000000,
      price_string: "12,000,000 AED",
      property_type: "Villa",
      reference: "ADM231368",
      region: "Dubai Hills Estate",
      title: "Sale in Sidra Villas I: Exclusive | Fully Renovated | Fully Furnished | Property Finder",
    },
  },
  {
    scraper: 'br_zapimoveis',
    fixture: 'br_zapimoveis',
    sourceUrl: 'https://www.zapimoveis.com.br/imovel/venda-apartamento-2-quartos-com-piscina-vila-ema-zona-leste-sao-paulo-sp-47m2-id-2870981622/',
    expected: {
      agent_company: "Orcioli Realizando Sonhos",
      city: "São Paulo",
      constructed_area: 47,
      count_bathrooms: 1,
      count_bedrooms: 2,
      ...
      price_float: 437500,
      price_string: "R$\u00A0437.500",
      reference: "2870981622",
      region: "Zona Leste",
