...
export const fixtures: FixtureEntry[] = [
  ...
  },
  {
    ...
    expected: {
      country: 'UK',
      currency: 'GBP',
      title: '3 bedroom semi-detached house for sale in Elm Grove, Brighton, BN2 - OnTheMarket',
      address_string: 'Elm Grove, Brighton, BN2',
  ...
  },
  {
    ...
    expected: {
      country: 'Ireland',
      currency: 'EUR',
      title: '3 Bed Semi-Detached House, 42 Griffith Avenue, Dublin 9 - Daft.ie',
      address_string: '42 Griffith Avenue, Dublin 9',
