...
export const fixtures: FixtureEntry[] = [
  ...
  },
  {
    scraper: 'es_fotocasa',
    fixture: 'es_fotocasa',
    sourceUrl: 'https://www.fotocasa.es/es/comprar/vivienda/madrid-capital/aire-acondicionado-calefaccion-ascensor-amueblado/188838714/d',
    expected: {
      country: 'Spain',
      currency: 'EUR',
      title: 'Piso en venta en Embajadores - Lavapi\u00E9s,  Madrid Capital',
      count_bedrooms: 2,
      count_bathrooms: 2,
      constructed_area: 70,
      price_string: '575.000 \u20AC',
      price_float: 575000,
      reference: '188838714',
      latitude: 40.4092,
      longitude: -3.6999369,
